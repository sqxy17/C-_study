...
//void test3()
//{
//    priority_queue<Date,vector<Date>,test_less<Date>>pq1;
//    pq1.push(Date(2011,2,3));
//    pq1.push(Date(2011,2,4));
//    pq1.push(Date(2011,2,5));
//    pq1.push(Date(2011,2,6));
//
//    cout<<pq1.top()<<endl;
//}
//
...
////    test2();
//
//    test3();//这个函数里面进行的测试是在容器中存放自定义类型的数据
//}